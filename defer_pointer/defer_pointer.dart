...
class DeferPointer extends StatelessWidget {
  const DeferPointer({super.key, required this.child, this.paintOnTop = false, this.link});
  final Widget child;
  ...
  Widget build(BuildContext context) {
    ...
    return _DeferPointerRenderObjectWidget(link: link, deferPaint: paintOnTop, child: child);
  }
}
...
class _DeferPointerRenderObjectWidget extends SingleChildRenderObjectWidget {
  const _DeferPointerRenderObjectWidget({required this.link, required Widget super.child, required this.deferPaint});
  ...
  @override
  RenderObject createRenderObject(BuildContext context) => DeferPointerRenderObject(link, deferPaint);

  @override
  void updateRenderObject(BuildContext context, DeferPointerRenderObject renderObject) {
...
class DeferPointerRenderObject extends RenderProxyBox {
  DeferPointerRenderObject(DeferredPointerHandlerLink link, this.deferPaint, {RenderBox? child}) : super(child) {
    this.link = link;
  }
